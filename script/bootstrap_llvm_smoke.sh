...
HIER_MODULE_LOADER_INPUT="$PROJECT_ROOT/bootstrap/hir_module_loader.jiang"
HIER_MODULE_LOADER_BIN="$BUILD_DIR/hir_module_loader"
COMPILER_JIR_LOWER_INPUT="$PROJECT_ROOT/bootstrap/compiler_jir_lower.jiang"
COMPILER_JIR_LOWER_BIN="$BUILD_DIR/compiler_jir_lower"
COMPILER_PARSER_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_parser_store.jiang"
COMPILER_PARSER_STORE_BIN="$BUILD_DIR/compiler_parser_store"
COMPILER_BUFFER_INT_INPUT="$PROJECT_ROOT/bootstrap/compiler_buffer_int.jiang"
COMPILER_BUFFER_INT_BIN="$BUILD_DIR/compiler_buffer_int"
COMPILER_BUFFER_BYTES_INPUT="$PROJECT_ROOT/bootstrap/compiler_buffer_bytes.jiang"
COMPILER_BUFFER_BYTES_BIN="$BUILD_DIR/compiler_buffer_bytes"
COMPILER_INTERN_POOL_INPUT="$PROJECT_ROOT/bootstrap/compiler_intern_pool.jiang"
COMPILER_INTERN_POOL_BIN="$BUILD_DIR/compiler_intern_pool"
COMPILER_MODULE_PATHS_INPUT="$PROJECT_ROOT/bootstrap/compiler_module_paths.jiang"
COMPILER_MODULE_PATHS_BIN="$BUILD_DIR/compiler_module_paths"
COMPILER_TOKEN_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_token_store.jiang"
COMPILER_TOKEN_STORE_BIN="$BUILD_DIR/compiler_token_store"
COMPILER_HIR_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_hir_store.jiang"
COMPILER_HIR_STORE_BIN="$BUILD_DIR/compiler_hir_store"
COMPILER_JIR_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_jir_store.jiang"
COMPILER_JIR_STORE_BIN="$BUILD_DIR/compiler_jir_store"
COMPILER_SYMBOL_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_symbol_store.jiang"
COMPILER_SYMBOL_STORE_BIN="$BUILD_DIR/compiler_symbol_store"
COMPILER_TYPE_STORE_INPUT="$PROJECT_ROOT/bootstrap/compiler_type_store.jiang"
COMPILER_TYPE_STORE_BIN="$BUILD_DIR/compiler_type_store"
HIR_PARSER_CORE_INPUT="$PROJECT_ROOT/bootstrap/hir_parser_core.jiang"
HIR_PARSER_CORE_BIN="$BUILD_DIR/hir_parser_core"
JIR_PARSER_CORE_INPUT="$PROJECT_ROOT/bootstrap/jir_parser_core.jiang"
JIR_PARSER_CORE_BIN="$BUILD_DIR/jir_parser_core"
HIR_LEXER_CORE_INPUT="$PROJECT_ROOT/bootstrap/hir_lexer_core.jiang"
HIR_LEXER_CORE_BIN="$BUILD_DIR/hir_lexer_core"
HIR_HIR_CORE_INPUT="$PROJECT_ROOT/bootstrap/hir_hir_core.jiang"
