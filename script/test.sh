...
run_sample semantic_ids_method_collision_minimal.jiang 42
...
run_sample semantic_ids_method_static_minimal.jiang 42
run_sample semantic_ids_generic_nominal_minimal.jiang 42
...
run_sample optional_some_infer_pattern_minimal.jiang 42
run_sample optional_some_tuple_pattern_minimal.jiang 42
...
run_sample deinit_minimal.jiang 0
...
run_compile_fail invalid_optional_some_bang_pattern.jiang
