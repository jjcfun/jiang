...
BINARY_STAGING="$RELEASE_DIR/stage2c-$VERSION-$TARGET"
BINARY_TARBALL="$RELEASE_DIR/stage2c-$VERSION-$TARGET.tar.xz"
...
tar -C "$RELEASE_DIR" -cJf "$BINARY_TARBALL" "stage2c-$VERSION-$TARGET"
