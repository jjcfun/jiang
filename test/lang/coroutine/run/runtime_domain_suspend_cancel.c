...
void runtime_suspend_registration_block(void) {
...
void runtime_suspend_registration_wait_ready(void) {
...
void runtime_suspend_registration_open_later(void) {
    pthread_create(&opener_thread, 0, open_registration, 0);
}

void runtime_suspend_registration_begin_cancel(void) {
    atomic_store(&cancel_started, 1);
}

void runtime_suspend_registration_join(void) {
